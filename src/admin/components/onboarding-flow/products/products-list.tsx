...
import { useAdminCreateProduct, useAdminCreateCollection } from "@simoko/shec-react";
  ...
  const createSample = async () => {
    try {
      ...
      const { product } = await createProduct({
        title: "Shec T-Shirt",
        description: "Comfy t-shirt with Shec logo",
        subtitle: "Black",
        is_giftcard: false,
        discountable: false,
        options: [{ title: "Size" }],
        images: [
          "https://shec-public-images.s3.eu-west-1.amazonaws.com/tee-black-front.png",
          "https://shec-public-images.s3.eu-west-1.amazonaws.com/tee-black-back.png",
        ],
