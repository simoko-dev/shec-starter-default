  ...
  return (
    <>
      ...
      <h2 className="text-base mt-5 pt-5 pb-5 font-semibold text-black border-t border-gray-300 border-solid">
        Start developing with Shec
      </h2>
      <p className="text-sm">
        Shec is a completely customizable commerce solution. We've curated
        some essential guides to kickstart your development with Shec.
      </p>
      <div className="grid grid-cols-2 gap-4 mt-5 pb-5 mb-5 border-b border-gray-300 border-solid">
        <a
          href="https://docs.simoko.com/starters/nextjs-shec-starter?path=simple-quickstart"
          target="_blank"
        >
          <div
        ...
        <a
          href="https://docs.simoko.com/recipes/?ref=onboarding"
          target="_blank"
        >
          <div
      ...
      <div>
        ...
        <a
          href="https://docs.simoko.com/?ref=onboarding"
          target="_blank"
