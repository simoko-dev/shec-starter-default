import { WidgetConfig, WidgetProps } from "@simoko/shec-admin";
import { useAdminCustomPost, useAdminCustomQuery } from "@simoko/shec-react";
...
const OnboardingFlow = (props: WidgetProps) => {
  ...
  const Steps: Step[] = [
    ...
    {
      id: "setup_finished",
      title: "Setup Finished: Start developing with Shec",
            ...
            {!completed ? (
              <>
                <div>
                  ...
                  <p>
                    Learn the basics of Shec by creating your first order.
                  </p>
                </div>
              ...
              <>
                <div>
                  ...
                  <p>
                    ...
                    following{" "}
                    <a
                      href="https://docs.simoko.com/admin/onboarding?ref=onboarding"
                      target="_blank"
