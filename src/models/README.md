...
import { generateEntityId } from "@simoko/shec-utils";
...
You also need to create a Migration to create the new table in the database. See [How to Create Migrations](https://docs.simoko.com/advanced/backend/migrations/) in the documentation.
...
See more about defining and accesing your custom [Entities](https://docs.simoko.com/advanced/backend/entities/overview) in the documentation.
